...
import modeling
import tokenization
from demo.AICExample import read_aic_examples, FeatureWriter, input_fn_builder, convert_examples_to_features
from demo.model import model_fn_builder
...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        # for test
        # eval_examples = eval_examples[:30]
